...
public class MemoryMonitor extends JPanel {
    ...
    public MemoryMonitor() {
        ...
        setBorder(new TitledBorder(new EtchedBorder(), "Monitor de Recursos de Sistema SuperBot"));
    ...
    public class MonitorComponent extends JPanel implements Runnable
    {
        ...
        public void paint(Graphics g) {
            ...
            big.drawString(String.valueOf((int) totalMemory/1024) + "K asignados",  4.0f, (float) ascent+0.5f);
            big.drawString(String.valueOf(((int) (totalMemory - freeMemory))/1024) + "K usados", 4, h-descent);
        ...
        public void start() {
            ...
            thread.setName("Estado de Memoria de SuperBot");
            thread.start();
        }
        ...
        public void run() {
            ...
            while (thread == me && isShowing()) {
                ...
                repaint();
                try {
                    thread.sleep(200);   //valor por defecto 999
  ...
  public static void main(String s[]) {
		...
		Frame f = new Frame("Diseño de Monitor de Memoria");
